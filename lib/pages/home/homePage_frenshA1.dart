...
import 'package:hib_testflu/data/FRcategory_data.dart';
import 'package:shared_preferences/shared_preferences.dart';
//import 'package:hib_testflu/widgets/category_icon.dart';
class homePage_frensh extends StatefulWidget {
  final String language;
  final String level;
  const homePage_frensh({super.key, required this.language, required this.level});

  @override
  State<homePage_frensh> createState() => _homePage_frenshState();
}

class _homePage_frenshState extends State<homePage_frensh> {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text("commencer votre  ${widget.level} voyage  \n d'apprentissage",
                    style: TextStyle(
                    ...
                    boxShadow:[
                      BoxShadow(
                        ...
                        blurStyle: BlurStyle.outer
                         ...
                         child: IconButton(
                      icon: Icon(Icons.logout, size: 26, color: Color.fromARGB(255, 252, 172, 207)),
                      onPressed: () async {
                        final prefs = await SharedPreferences.getInstance();
